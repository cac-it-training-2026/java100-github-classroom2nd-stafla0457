...
public class Patisserie {
	public static void main(String[] args) throws IOException {
		...
		double chocolateBuyCount = Double.parseDouble(chocolatBuyCountStr);
		...
		System.out.println(
				"合計金額 " + (int) (250 * citronBuyCount + 280 * chocolateBuyCount + 320 * pistacheBuyCount) + "円");

		System.out.println("\nをお買い上げですね。");
		System.out.println("承りました。");

		citronstock = (int) (30 - citronBuyCount);
		chocolatstock = (int) (30 - chocolateBuyCount);
